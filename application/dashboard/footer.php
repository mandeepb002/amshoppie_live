        ...
        <!-- jQuery UI 1.10.3 -->
        <script src="<?php echo base_url(); ?>assets/seller/js/jquery-ui-1.10.3.min.js" type="text/javascript"></script>
        <!-- Bootstrap -->
        <script src="<?php echo base_url(); ?>assets/seller/js/bootstrap.min.js" type="text/javascript"></script>
        <!-- daterangepicker -->
        <script src="<?php echo base_url(); ?>assets/seller/js/plugins/daterangepicker/daterangepicker.js" type="text/javascript"></script>
        ...
        <!-- calendar -->
        <script src="<?php echo base_url(); ?>assets/seller/js/plugins/fullcalendar/fullcalendar.js" type="text/javascript"></script>
