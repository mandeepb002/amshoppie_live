...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Advertisement | Documents</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="add-product.html"> <i class="fa fa-plus" aria-hidden="true"></i> Add Product</a>
                            </li>
                            <li>
                                <a href="view-product.html"> <i class="fa fa-eye" aria-hidden="true"></i> View Product</a>
                            </li>
                        </ul>
                    </li>
