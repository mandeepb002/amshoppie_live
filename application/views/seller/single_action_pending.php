<!-- Right side column. Contains the navbar and content of the page -->
            <aside class="right-side">
				...
				<h2 class="section-title add-p02"> View Action Panding Detail </h2>
			...
			?>
					...
					<div class="row">
					  ...
					  <div><a href="<?php base_url(); ?>http://amshoppie.com/seller/action_pending" class="btn btn-default back-btn">BACK</a></div>
