...
<!-- Right side column. Contains the navbar and content of the page -->
            <aside class="right-side">
				...
				<h2 class="section-title add-p02"> View Cancel Order Detail </h2>
				...
				<div class="col-md-8 col-sm-4 col-xs-4">
					...
					<div class="row">
					  ...
					  <div><a href="<?php base_url(); ?>https://amshoppie.com/seller/track_order" class="btn btn-default back-btn">BACK</a></div>
