        ...
        <script src="<?php echo base_url(); ?>assets/admin/js/plugins/chart.js" type="text/javascript"></script>
        ...
        <!-- calendar -->
        <script src="<?php echo base_url(); ?>assets/admin/js/plugins/fullcalendar/fullcalendar.js" type="text/javascript"></script>

        <!-- Director App -->
        <script src="<?php echo base_url(); ?>assets/admin/js/Director/app.js" type="text/javascript"></script>

        <!-- Director dashboard demo (This is only for demo purposes) -->
        <script src="<?php echo base_url(); ?>assets/admin/js/Director/dashboard.js" type="text/javascript"></script>
